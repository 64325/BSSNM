...
"""
# Update !
#  - 9 NEW MAPS OMG !!!!!1!1!1!!!!1 | 9 Nuevos mapas 
#  - MAPS ONLY MODELS AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
#  - Fix Bugs 
#  - New New background to some maps || Nueva vista previa en algunos mapas
"""
#  - Notas de tz || in spanish please
#  - Pues bueno, he aqui la version casi final del mod de los mapas. Este mod surgio luego de que fuera lanzado el memory game a la 1.7
#    haciendo que zacker se interese por las prataformas que tenia el minijuego y diciendo a sebastian si lograba replicarlo
#    luego de ello salio el primer mapa "PLATFORMS" , el primer mapa para este mod y el primero en tener movimiento, luego de ello surgirian 
#    mas mapas realizados con los modelos de la TNT y powerups. Poco a poco se fueron creando mas y mas mapas hasta llegar al primer mapa que 
#    usaria modelos de otros mapas para fusionarse, el primero de estos fue el Skull temple (se llamaba spaz map al inicio jaaj) Los tiempos pasaron
#    y surgieron varias ideas para mas mapas y termino en todos los mapas de ahora mismo
#  - Mod logrado gracias a Sebastian2059, el cual hizo que toda la creaccion de los mapas sea mas facil de realizar y practicamente todo el codigo es de el
#    zacker solamente le ayudo con el diseño y creaccion de algunos mapas. :bear_wave: :bear_wave: :bear_wave: :bear_wave: :bear_wave: 
#  - Mod realizado con mucho esfuerzo cof exclavitud cof  por parte de sebastian. 100 likes para que le pague a sebastian 10 pesos
#  - Especial Gracias a byAngel por la promocion del mod! :bear_wave:
