    ...
    def handlemessage(self, msg: Any) -> Any:
        ...
        if isinstance(msg, ba.PickedUpMessage):
            ...
            if not self._dead:
                ...
                if killed and self.immortal:
                    return None

                activity = self._activity()

                player = self.getplayer(ba.Player, False)
                for activityplayer in activity.players:
                    if activityplayer.actor == self:
                ...
                if killed and activity is not None and player and player.actor == self:
